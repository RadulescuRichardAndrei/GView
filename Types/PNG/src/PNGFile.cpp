...
bool PNGFile::LoadImageToObject(const std::string_view& path)
{
...
std::string_view PNGFile::GetTypeName()
{
    return "PNG";
}

Reference<GView::View::BufferViewer::SelectionZoneInterface> PNGFile::GetSelectionZoneInterface()
{
    return selectionZoneInterface;
}

void PNGFile::SetSelectionZoneInterface(Reference<GView::View::BufferViewer::SelectionZoneInterface> interface)
{
